...
public class CalculationListTable extends JTable implements DragGestureListener, DragSourceListener {

    public CalculationListTable(TableModel model) {
        super(model);
    ...
    public void dragGestureRecognized(DragGestureEvent dge) {
        CalculationListTableModel model = (CalculationListTableModel) getModel();
        Point location = dge.getDragOrigin();
        int i = this.getSelectedRow();
        Calculation calculation = model.getCalculationAt(i);
        if (calculation != null) {
            Transferable transferable = new SimpleTransferable(calculation);
